...
namespace Software_prueba
{
    public partial class Form1 : Form
    {
       ...
       //metodos
        ...
        private void Boton_Pacientes_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.FormPacientes(), sender);
        }

        private void Boton_Historias_clinicas_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.FormHistoria(), sender);
        }
        ...
        private void Boton_Afiliaciones_Click(object sender, EventArgs e)
        {
